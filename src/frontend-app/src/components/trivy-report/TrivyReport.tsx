...
const TrivyReport: React.FC<TrivyReportProps> = ({ vulnerabilities, misconfigurations, misconfigurationSummary, k8sClusterSummaryInfraAssessment, 
  k8sClusterSummaryRBACAssessment, vulnerabilitiesOrMisconfigurations, supplyChainSBOM, setVulnerabilitiesOrMisconfigurations }) => {
